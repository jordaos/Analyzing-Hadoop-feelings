...
# File location
old_emotion_list = open('../data/sentistrength_data/EmotionLookupTable-old.txt', 'r')

# File location
new_emotion_list = open('../data/sentistrength_data/EmotionLookupTable.txt', 'w')

# File location
neutral_words = open('../data/words-neutral.txt', 'r')
